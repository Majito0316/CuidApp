<?php
// dashboards/cuidador.php
require_once __DIR__ . '/../includes/conexion.php';
require_once __DIR__ . '/../includes/guards.php';

// Solo cuidadores (rol = 2)
require_role([2]);
...
<head>
  ...
  <title>CuidApp — Cuidador</title>
  <!-- Si tienes un CSS específico para cuidador, cámbialo por ../css/dashboardCuidador.css -->
...
<body>
  ...
  <main>
    <div class="grid">
      ...
      <!-- Usuarios: como cuidador sí aplica (gestión de pacientes a cargo, etc.) -->
  ...
  <footer>
    <nav>
      ...
      <button type="button" title="Inicio" onclick="location.href='dashboardCuidador.php'">
        <img src="../imagenes/logo.png" width="40" alt="Inicio">
      </button>
      <button type="button" title="Nuevo (Medicamentos)" onclick="location.href='../modulos/medicamentos.php?view=ficha'">
